...
export default function InfoSharingForm({ data, onChange, validationErrors }) {
  ...
  return (
    <div className="space-y-4">
      <p className="text-sm text-muted-foreground mb-4">请输入信息分享的标题、副标题和章节。这将显示在使徒信经之后。</p>
      ...
      <div className="space-y-2">
        <Label htmlFor="info-sharing-subtitle">副标题</Label>
        <Input
          id="info-sharing-subtitle"
          value={data.infoSharingSubtitle}
          onChange={(e) => handleChange("infoSharingSubtitle", e.target.value)}
        />
      </div>
